#ifndef ICEBERGCHANNELMAPV100_HPP_
#define ICEBERGCHANNELMAPV100_HPP_
...
public:
  ...
  explicit ICEBERGChannelMapV100() {
    ...
    TLOG(10) << "ICEBERGChannelMapV100 Created";
  }

  ICEBERGChannelMapV100(const ICEBERGChannelMapV100&) = delete;
  ICEBERGChannelMapV100& operator=(const ICEBERGChannelMapV100&) = delete;
  ICEBERGChannelMapV100(ICEBERGChannelMapV100&&) = delete;
  ICEBERGChannelMapV100& operator=(ICEBERGChannelMapV100&&) = delete;
...
#endif // ICEBERGCHANNELMAPV100_HPP_
