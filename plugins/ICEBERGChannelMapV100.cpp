...
class ICEBERGChannelMapV100 :  public TPCChannelMap
{
public:

  explicit ICEBERGChannelMapV100() {
    ...
    std::string channel_map_file = detchannelmaps_share + "/config/iceberg/iceberg_wibeth_chanmap_v100.txt";
  ...
  ICEBERGChannelMapV100(const ICEBERGChannelMapV100&) = delete;            ///< ICEBERGChannelMapV100 is not copy-constructible
  ICEBERGChannelMapV100& operator=(const ICEBERGChannelMapV100&) = delete; ///< ICEBERGChannelMapV100 is not copy-assignable
  ICEBERGChannelMapV100(ICEBERGChannelMapV100&&) = delete;                 ///< ICEBERGChannelMapV100 is not move-constructible
  ICEBERGChannelMapV100& operator=(ICEBERGChannelMapV100&&) = delete;      ///< ICEBERGChannelMapV100 is not move-assignable
...
DEFINE_DUNE_DET_CHANNEL_MAP(dunedaq::detchannelmaps::ICEBERGChannelMapV100)
